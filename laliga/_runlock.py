"""
Cross-process scrape lock — serialises LALIGA scrapers so only ONE runs at a time.
...
log = logging.getLogger("laliga.runlock")
...
_LOCK_PATH = _LOCK_DIR / "laliga_scrape.lock"
