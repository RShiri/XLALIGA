...
<!-- progress:lessons -->
- ❌ **Didn't work** — 5 of the 14 26/27 matches saved with FotMob data only (sources=['fotmob']): no pass/dribble/save maps, lineups with every player as 'MC' and no subs or ratings, and no player rows at all — players.js held 26 of 37 goals and was missing Atletico Madrid, Deportivo A Coruna and Malaga entirely. backfill printed the partial count but never journalled it, so the row read '12 saved OK'. The note now carries it. Fix: backfill --redo-partial.  (2026-08-25)
